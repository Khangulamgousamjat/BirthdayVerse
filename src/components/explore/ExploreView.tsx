  ...
  return (
    <div className="w-full max-w-7xl mx-auto space-y-16 py-6 animate-in fade-in duration-300">
      ...
      <section className="text-center max-w-3xl mx-auto pt-6 pb-4 space-y-6">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#F1EBFD] dark:bg-[#261F36] text-[#7659E4] dark:text-[#C495C8] text-xs font-semibold shadow-xs">
          <Sparkles className="w-3.5 h-3.5 text-[#7659E4]" />
          <span>The Next Generation Birthday Experience</span>
        </div>

        <h1 className="text-4xl sm:text-5xl md:text-6xl font-display font-bold text-[#211A30] dark:text-[#F9F7FD] leading-tight tracking-tight">
          Make their birthday <br />
          <span className="bv-gradient-text">a little more magical.</span>
        </h1>

        <p className="text-sm sm:text-base text-[#736886] dark:text-[#A89EC0] max-w-xl mx-auto leading-relaxed">
      ...
      <section className="space-y-10">
        <div className="text-center max-w-xl mx-auto space-y-1">
          <h2 className="text-2xl sm:text-3xl font-display font-bold text-[#211A30] dark:text-[#F9F7FD]">
            How BirthdayVerse Works
          </h2>
          <p className="text-xs sm:text-sm text-[#736886] dark:text-[#A89EC0]">
            Create an unforgettable celebration in under two minutes.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
          <div className="p-8 rounded-3xl bg-white dark:bg-[#1E182A] border border-[#E8DFFA] dark:border-[#282038] shadow-xs space-y-3">
            <div className="w-12 h-12 rounded-2xl bg-[#F1EBFD] dark:bg-[#261F36] text-[#7659E4] dark:text-[#C495C8] flex items-center justify-center text-lg font-bold">
              1
            </div>
      ...
      {/* Feature Highlights */}
      <section className="p-8 sm:p-12 rounded-3xl bg-gradient-to-br from-[#161220] to-[#211832] text-white border border-[#282038] text-left space-y-8">
        <div className="max-w-xl space-y-2">
          <span className="text-xs font-bold uppercase tracking-wider text-[#E0A842]">
            Crafted for Emotion
          </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="space-y-1.5">
            <div className="flex items-center gap-2 text-[#E0A842] font-semibold text-xs">
              <Gift className="w-4 h-4" />
              <span>Interactive Cake</span>
            </div>
            <p className="text-[11px] text-[#A89EC0] leading-relaxed">
              Candles with real-time extinguishing and celebration confetti.
            </p>
          </div>

          <div className="space-y-1.5">
            <div className="flex items-center gap-2 text-[#8E72F0] font-semibold text-xs">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center gap-2 text-[#C495C8] font-semibold text-xs">
